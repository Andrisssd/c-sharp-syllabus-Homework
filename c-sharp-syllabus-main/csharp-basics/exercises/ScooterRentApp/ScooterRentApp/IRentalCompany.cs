...
namespace ScooterRentApp
{
    interface IRentalCompany
    {
        ...
        void StartRent(string id, Dictionary<string, Scooter> dictionary, DateTime timeRented);
        /// <summary>
        ...
        decimal EndRent(string id, Dictionary<string, Scooter> dictionary, DateTime time);
        /// <summary>
        /// Income report.
        /// </summary>
        ...
        decimal CalculateIncome(int year, bool includeNotCompletedRentals, Dictionary<string, Scooter> scooters, DateTime callTime);
    }
}
